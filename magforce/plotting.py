...
def plot_1D_along_x(xs=array([]), y=0, z=0, collection=None, sample=None, BF='BF', saveCSV=False, figDetail=None):
    """
    -----------
    DESCRIPTION
    -----------
    ...
    :param figDetail: str | will be added to the name of the figure generated by the function
    ...
    if 'B' in BF:
        ...
        fig_B = figure(num=f'''B for y = {y}, z = {z}'''+(f'''; {figDetail}''' if figDetail else ''))
    ...
    if 'F' in BF:
        ...
        # create figure to host 4 plots in 2x2 disposition
        fig_F = figure(num=f'''F for y = {y}, z = {z}'''+(f'''; {figDetail}''' if figDetail else ''))
...
def plot_1D_along_y(x=0, ys=array([]), z=0, collection=None, sample=None, BF='BF', saveCSV=False, figDetail=None):
    """
    -----------
    DESCRIPTION
    -----------
    ...
    if 'B' in BF:
        ...
        # create figure to host 4 plots in 2x2 disposition
        fig_B = figure(num=f'''B for x = {x}, z = {z}'''+(f'''; {figDetail}''' if figDetail else ''))
    ...
    if 'F' in BF:
        ...
        # create figure to host 4 plots in 2x2 disposition
        fig_F = figure(num=f'''F for x = {x}, z = {z}'''+(f'''; {figDetail}''' if figDetail else ''))
...
def plot_1D_along_z(x=0, y=0, zs=array([]), collection=None, sample=None, BF='BF', saveCSV=False, figDetail=None):
    """
    -----------
    DESCRIPTION
    -----------
    ...
    if 'B' in BF:
        ...
        # create figure to host 4 plots in 2x2 disposition
        fig_B = figure(num=f'''B for x = {x}, y = {y}'''+(f'''; {figDetail}''' if figDetail else ''))
    ...
    if 'F' in BF:
        ...
        # create figure to host 4 plots in 2x2 disposition
        fig_F = figure(num=f'''F for x = {x}, y = {y}'''+(f'''; {figDetail}''' if figDetail else ''))
...
def plot_2D_plane_x(x=0, ys=array([]), zs=array([]), collection=None, sample=None, modes=['stream'], BF='BF', saveCSV=False, figDetail=None):
    """
    -----------
    DESCRIPTION
    -----------
    ...
    if 'B' in BF:
        ...
        if 'stream' in modes:
            ...
            fig_B_stream = figure(num=f'''B x = {x} stream'''+(f'''; {figDetail}''' if figDetail else ''))
        ...
        if 'quiver' in modes:
            # creation of figure to host the plot
            fig_B_quiver = figure(num=f'''B x = {x} quiver'''+(f'''; {figDetail}''' if figDetail else ''))
        ...
        if 'surface' in modes:
            ...
            fig_B_surface = figure(num=f'''B, x = {x} surface'''+(f'''; {figDetail}''' if figDetail else ''))
    ...
    if 'F' in BF:
        ...
        if 'stream' in modes:
            # creation of figure to host the plot
            fig_F_stream = figure(num=f'''F x = {x} stream'''+(f'''; {figDetail}''' if figDetail else ''))
        ...
        if 'quiver' in modes:
            # creation of figure to host the plot
            fig_F_quiver = figure(num=f'''F x = {x} quiver'''+(f'''; {figDetail}''' if figDetail else ''))
        ...
        if 'surface' in modes:
            # creation of figure to host the plots
            fig_F_surface = figure(num=f'''F, x = {x} surface'''+(f'''; {figDetail}''' if figDetail else ''))
...
def plot_2D_plane_y(xs=array([]), y=0, zs=array([]), collection=None, sample=None, modes=['stream'], BF='BF', saveCSV=False, figDetail=None):
    """
    -----------
    DESCRIPTION
    -----------
    ...
    if 'B' in BF:
        ...
        if 'stream' in modes:
            # creation of figure to host the plot
            fig_B_stream = figure(num=f'''B y = {y} stream'''+(f'''; {figDetail}''' if figDetail else ''))
        ...
        if 'quiver' in modes:
            # creation of figure to host the plot
            fig_B_quiver = figure(num=f'''B y = {y} quiver'''+(f'''; {figDetail}''' if figDetail else ''))
        ...
        if 'surface' in modes:
            # creation of figure to host the plots
            fig_B_surface = figure(num=f'''B, y = {y} surface'''+(f'''; {figDetail}''' if figDetail else ''))
    ...
    if 'F' in BF:
        ...
        if 'stream' in modes:
            # creation of figure to host the plot
            fig_F_stream = figure(num=f'''F y = {y} stream'''+(f'''; {figDetail}''' if figDetail else ''))
        ...
        if 'quiver' in modes:
            # creation of figure to host the plot
            fig_F_quiver = figure(num=f'''F y = {y} quiver'''+(f'''; {figDetail}''' if figDetail else ''))
        ...
        if 'surface' in modes:
            # creation of figure to host the plots
            fig_F_surface = figure(num=f'''F, y = {y} surface'''+(f'''; {figDetail}''' if figDetail else ''))
...
def plot_2D_plane_z(xs=array([]), ys=array([]), z=0, collection=None, sample=None, modes=['stream'], BF='BF', saveCSV=False, figDetail=None):
    """
    -----------
    DESCRIPTION
    -----------
    ...
    if 'B' in BF:
        ...
        if 'stream' in modes:
            # creation of figure to host the plot
            fig_B_stream = figure(num=f'''B z = {z} stream'''+(f'''; {figDetail}''' if figDetail else ''))
        ...
        if 'quiver' in modes:
            # creation of figure to host the plot
            fig_B_quiver = figure(num=f'''B z = {z} quiver'''+(f'''; {figDetail}''' if figDetail else ''))
        ...
        if 'surface' in modes:
            # creation of figure to host the plots
            fig_B_surface = figure(num=f'''B, z = {z} surface'''+(f'''; {figDetail}''' if figDetail else ''))
    ...
    if 'F' in BF:
        ...
        if 'stream' in modes:
            # creation of figure to host the plot
            fig_F_stream = figure(num=f'''F z = {z} stream'''+(f'''; {figDetail}''' if figDetail else ''))
        ...
        if 'quiver' in modes:
            # creation of figure to host the plot
            fig_F_quiver = figure(num=f'''F z = {z} quiver'''+(f'''; {figDetail}''' if figDetail else ''))
        ...
        if 'surface' in modes:
            # creation of figure to host the plots
            fig_F_surface = figure(num=f'''F, z = {z} surface'''+(f'''; {figDetail}''' if figDetail else ''))
...
def plot_3D(xs=array([]), ys=array([]), zs=array([]), collection=None, sample=None, BF='BF', saveCSV=False, figDetail=None):
    """
    -----------
    DESCRIPTION
    -----------
    ...
    if 'B' in BF:
        ...
        # plotting
        fig3d_B = figure(num='B 3D'+(f'''; {figDetail}''' if figDetail else ''))
    ...
    if 'F' in BF:
        ...
        # plotting
        fig3d_F = figure(num='F 3D'+(f'''; {figDetail}''' if figDetail else ''))
