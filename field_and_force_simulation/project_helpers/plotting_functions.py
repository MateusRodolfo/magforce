...
def plot_1D_along_x(xs=array([]), y=0, z=0, collection=None, sample=None, BF='BF'):
    """
    -----------
    DESCRIPTION
    -----------
    ...
    # pass BF to lowercase to avoid BF='bf' not returning anything
    bf = BF.lower()
...
def plot_1D_along_y(x=0, ys=array([]), z=0, collection=None, sample=None, BF='BF'):
    """
    -----------
    DESCRIPTION
    -----------
...
def plot_1D_along_z(x=0, y=0, zs=array([]), collection=None, sample=None, BF='BF'):
    """
    -----------
    DESCRIPTION
    -----------
...
def plot_2D_plane_x(x=0, ys=array([]), zs=array([]), collection=None, sample=None, modes=['stream'], BF='BF'):
    """
    -----------
    DESCRIPTION
    -----------
...
def plot_2D_plane_y(xs=array([]), y=0, zs=array([]), collection=None, sample=None, modes=['stream'], BF='BF'):
    """
    -----------
    DESCRIPTION
    -----------
...
def plot_2D_plane_z(xs=array([]), ys=array([]), z=0, collection=None, sample=None, modes=['stream'], BF='BF'):
    """
    -----------
    DESCRIPTION
    -----------
...
def plot_3D(xs=array([]), ys=array([]), zs=array([]), collection=None, sample=None, BF='BF'):
    """
    -----------
    DESCRIPTION
    -----------
