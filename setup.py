...
setup(
  ...
  url = 'https://github.com/MateusRodolfo/magforce',   # Provide either the link to your github or to your website
  download_url = 'https://github.com/MateusRodolfo/magforce/archive/v2.1.tar.gz',    # I explain this later on
